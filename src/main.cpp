...
unsigned int nStakeMinAge = 60 * 60 * 2  * 1;	//2h, minimum age for coin age:  6h
unsigned int nStakeMaxAge = 60 * 60 * 24 * 10;	//10d, stake age of full weight:  10d 60*60*24*10
unsigned int nStakeTargetSpacing = 60;			// 60 sec block spacing

int64 nChainStartTime = 1407606791;
...
const string strMessageMagic = "alipaycoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    int64_t nSubsidy = 0 * COIN;
     ...
     if(nHeight < 2  ) nSubsidy = 3000000 * COIN;
else if(nHeight < 800000) nSubsidy = 1 * COIN;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in alipaycoin
    bool fStrictPayToScriptHash = true; // Always active in alipaycoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "alipaycoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "alipaycoin dev 2014-08-09";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x5ae57332b92b318f375cc013a264e5da501a5f3285be9ef7c8ca1efb11076e82"));
...
unsigned char pchMessageStart[4] = { 0x7e, 0x15, 0xd2, 0x05 };
